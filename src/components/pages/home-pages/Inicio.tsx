...
import CurvedLine from "@assets/home-page/curv-line.svg";
...
const GlobeSVG = dynamic(()=> import ("@components/magic-ui").then(mod => mod.GlobeSVG),{
    ssr: false,
    loading: () => <div className="w-[240px] h-[240px] bg-gray-100 animate-pulse rounded-full" />,
})
            ...
            <section className="relative w-full max-w-screen-xl mx-auto px-4 lg:py-12 mt-12">
                <div className="absolute top-0 left-0 z-0 hidden 2xl:block">
                    <Image
                        src={CurvedLine}
                        alt="Curved line"
                        className="scale-[2] origin-top-left -translate-x-10 -translate-y-[60px]"
                    />
                </div>
